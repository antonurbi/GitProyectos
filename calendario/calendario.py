...
class GoogleCalendarManager:
    ...
    def list_upcoming_events(self, max_results=10):
        ...
        events_result = self.service.events().list(
            calendarId='primary', timeMin=now, timeMax=tomorrow, #tomorrow o la fecha
    ...
    def create_event(self, summary, start_time, end_time, timezone, attendees, colorId):
        event = {
            'summary': summary,
            'start': {
                'dateTime': start_time,
...
def main():
    ...
    attendees = ["gmail@gmail.com"]
    timezone = "Europe/Madrid"
    school_organization_task = [
    {
        "summary": "",
    ...
    {
        "summary": "",
        "start_time": "2024-11-04T10:00:00",
        "end_time": "2024-11-04T12:00:00",
        "timezone": "Europe/Madrid",
        "attendees": [],
        "colorId": "2"
    }
]
    # Itera a través de las tareas y crea los eventos en Google Calendar
    for task in school_organization_task:
